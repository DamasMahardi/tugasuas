...
if(isset($_GET['submit'])&& !empty($_GET['q'])){
  $q= $_GET['q'];
  $a= $_GET['a'];
  $sql_where = " WHERE nama_barang='{$q}' AND nama_kategori='{$a}'";
}
$title = 'data barang';
include_once 'koneksi.php';

$sql = "SELECT  b.id_barang,b.id_kategori,b.nama_barang,k.nama_kategori,b.harga_jual,b.harga_beli,b.stok,b.gambar
...
<div class="content_b">
  <div class="main">
    ...
    <form action="barang.php" method="get">
      ...
      <select id ="a" name="a" class="input-a"  value="<?php echo $a ?>" >
         ...
         <tr>
          ...
          <td><?php echo $row['nama_barang']; ?></td>
           ...
           <td class="center">
             ...
             <a class="btn btn-alert" onclick="return confirm('Yakin akan menghapus data?');" href="delete_barang.php?id=<?php echo $row['id_barang'];?>">Delete</a>
           </td>
         </tr>
       <?php endwhile;?>
     </table>
    ...
    <ul class="pagination">
      <?php
            ...
            ?>
             ...
             <li><a href="barang.php?page=<?php echo $page-1;?>">&laquo;</a></li>
       ...
       <?php for ($i=1; $i <=$num_page; $i++) {
         ...
         echo "<li><a class=\"{$class}\" href=\"{$link}\">{$i}</a></li>";
            ...
            ?>
               <li><a href="barang.php?page=<?php echo $page+1;?>">&raquo;</a></li>
