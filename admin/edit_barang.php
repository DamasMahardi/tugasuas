...
$sql .= "nama_barang ='{$nama}', id_kategori ='{$kategori}', ";
...
<div class="main">
<h2> Edit Barang</h2>
<form class="" action="edit_barang.php" method="post"
...
$row['id_kategori'];?>"> <?php echo $row['nama_kategori'];?></option>
<?php endwhile; ?>
</select>
</div>
<div class="input">
...
<div class="input">
<label>Stok</label>
<input type="text" name="stok" value="<?php
echo $data['stok'];?> " />
</div>
<div class="input">
